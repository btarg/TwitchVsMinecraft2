...
public class ChatCommands {
    ...
    public static void initCommands() {
        ...
        registerCommand(() -> CommandHandlers.addPotionEffects(effect(Effects.MOVEMENT_SLOWDOWN, 400, 5)), "slowness");
        registerCommand(() -> CommandHandlers.addPotionEffects(effect(Effects.BLINDNESS, 400, 0)), "blindness", "jinkies");
        registerCommand(() -> CommandHandlers.addPotionEffects(effect(Effects.MOVEMENT_SPEED, 400, 10)), "speed", "gottagofast");
        registerCommand(() -> CommandHandlers.addPotionEffects(effect(Effects.CONFUSION, 400, 0)), "nausea", "dontfeelsogood");
        registerCommand(() -> CommandHandlers.addPotionEffects(effect(Effects.DIG_SLOWDOWN, 400, 0)), "fatigue");
        ...
        registerCommand(() -> CommandHandlers.addPotionEffects(effect(Effects.JUMP, 400, 2)), "jumpboost", "yeet");
        registerCommand(() -> CommandHandlers.addPotionEffects(effect(Effects.DIG_SPEED, 400, 2)), "haste", "diggydiggy");
        registerCommand(() -> CommandHandlers.addPotionEffects(effect(Effects.BAD_OMEN, 400, 0)), "badomen", "pillager", "raid");
        registerCommand(() -> CommandHandlers.addPotionEffects(effect(Effects.FIRE_RESISTANCE, 800, 0), effect(Effects.DAMAGE_RESISTANCE, 800, 4)), "resistance");
        ...
        registerCommand(() -> CommandHandlers.playSound(SoundEvents.CREEPER_PRIMED, SoundCategory.HOSTILE, 1.0F, 1.0F), "creeperscare", "behindyou");
        registerCommand(() -> CommandHandlers.playSound(SoundEvents.ZOMBIE_AMBIENT, SoundCategory.HOSTILE, 1.0F, 1.0F), "zombiescare", "bruh");
        registerCommand(() -> CommandHandlers.playSound(SoundEvents.SKELETON_AMBIENT, SoundCategory.HOSTILE, 1.0F, 1.0F), "skeletonscare", "spook");
        registerCommand(() -> CommandHandlers.playSound(SoundEvents.WITCH_AMBIENT, SoundCategory.HOSTILE, 1.0F, 1.0F), "witchscare", "hehe");
        registerCommand(() -> CommandHandlers.playSound(SoundEvents.GHAST_WARN, SoundCategory.HOSTILE, 10.0F, 1.0F), "ghastscare", "yikes");
        registerCommand(() -> CommandHandlers.playSound(SoundEvents.PHANTOM_AMBIENT, SoundCategory.HOSTILE, 10.0F, 1.0F), "phantomscare", "needsleep");
        registerCommand(() -> CommandHandlers.playSound(SoundEvents.WITHER_AMBIENT, SoundCategory.HOSTILE, 10.0F, 1.0F), "witherscare", "wither");
        ...
        registerCommand(() -> CommandHandlers.playSound(SoundEvents.ANVIL_FALL, SoundCategory.BLOCKS, 1.0F, 1.0F), "anvilscare");
        ...
        registerCommand(() -> PlayerHelper.player().inventory.dropAll(), "dropall");
